/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.cloudflare.jsonc` (hash: 5ed6f0955f6318d99f91331c3389739b)
// Runtime types generated with workerd@1.20260801.1 2026-08-05 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	CORECARE_OWNER_EMAILS: "chriswarman21@yahoo.co.uk,ekgeneralstore@gmail.com";
	TURNSTILE_HOSTNAMES: "corecaresystems.co.uk,www.corecaresystems.co.uk,login.corecaresystems.co.uk";
	CORECARE_PLATFORM: Service /* entrypoint PortalBroker from corecare-platform */;
	CORECARE_PLATFORM_AUTOMATION: Fetcher /* corecare-platform */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORECARE_OWNER_EMAILS" | "TURNSTILE_HOSTNAMES">> {}
}
