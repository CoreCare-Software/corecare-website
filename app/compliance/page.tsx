...
export default function CompliancePage() {
  return <MarketingShell><section className="content-hero"><div className="site-shell narrow-heading"><p className="eyebrow">Data protection</p><h1>Clear responsibilities, one control centre.</h1><p className="content-lead">CoreCare publishes one set of customer-facing documents for the suite. The Owner Platform coordinates privacy cases and breach records, while each product keeps the operational evidence relevant to that service.</p><p className="updated-note">Compliance library reviewed 5 August 2026</p></div></section>
