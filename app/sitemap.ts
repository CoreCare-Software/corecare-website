...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = ["", "/demos", "/trial", "/plans", "/support", "/account-help", "/security", "/compliance", "/privacy", "/data-rights", "/data-processing-agreement", "/customer-terms", "/data-retention", "/subprocessors", "/cookies", "/terms", "/legal", "/contact"];
