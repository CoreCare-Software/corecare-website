...
test('publishes the CoreCare compliance library and tracked rights route', async () => {
  const [privacy,dpa,terms,retention,rights,security,subprocessors,route,migration] = await Promise.all([
    source('app/privacy/page.tsx'),source('app/data-processing-agreement/page.tsx'),source('app/customer-terms/page.tsx'),source('app/data-retention/page.tsx'),source('app/data-rights/page.tsx'),source('app/security/page.tsx'),source('app/subprocessors/page.tsx'),source('app/api/privacy/requests/route.ts'),source('drizzle/0003_privacy_rights.sql')
  ]);
