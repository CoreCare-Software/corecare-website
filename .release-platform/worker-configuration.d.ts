/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 98e56a4bba929b320e1f14ae98d5a52c)
// Runtime types generated with workerd@1.20260730.1 2026-08-03 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ATTACHMENTS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	CORECARE_ENVIRONMENT: "staging" | "production";
	CORECARE_CARE: Fetcher /* corecare-care */;
	CORECARE_POS: Fetcher /* corecare-pos */;
	CORECARE_GARAGE: Fetcher /* corecare-garage */;
	CORECARE_CAMPSITE: Fetcher /* corecare-campsite */;
	CORECARE_FINANCE: Fetcher /* corecare-finance */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORECARE_ENVIRONMENT">> {}
}
